...
adminId!: string;
  ...
  reprovarEmpresa(id: string): void {
    const config = new MatDialogConfig();
            ...
            config.data = {
              mensagem: 'Deseja reprovar esta empresa? Esta ação não pode ser desfeita.',
